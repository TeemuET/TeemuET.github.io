...
* **Methodological Advancements**: Is the new online method proposed by Deshpande et al. (2024) fundamentally different from the older methods that sparked initial critiques of recalibrated BO?
...
The repository for the experiment framework is available which builds on the work by Foldager et al. {% cite pmlr-v216-foldager23a %} [here](https://github.com/TeemuET/online-calibrated-bo-experiments).